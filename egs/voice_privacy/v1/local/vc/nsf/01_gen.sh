...
export TEMP_WAVEFORM_MODEL_NETWORK_PATH=exp/nsf_model/trained_network_yaaptf0.jsn
#export TEMP_WAVEFORM_MODEL_NETWORK_PATH=exp/nsf_model/trained_network_kaldif0.jsn
