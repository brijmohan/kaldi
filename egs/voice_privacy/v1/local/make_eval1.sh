...
local/data_prep_adv.sh ${librispeech_corpus}/test-clean data/${enroll_data}
local/data_prep_adv.sh ${librispeech_corpus}/test-clean data/${trial_data}

rm data/${enroll_data}/text data/${enroll_data}/spk2utt
rm data/${trial_data}/text data/${trial_data}/spk2utt

python local/fix_eval1.py ${proto_dir} data/${enroll_data} data/${trial_data} || exit 1;
