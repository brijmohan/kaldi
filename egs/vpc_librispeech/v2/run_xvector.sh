...
#
# This example demonstrates a "bare bones" Librispeech recipe using xvectors.
...
# SRE16 trials
# Modify these files to give your own trial files
...
if [ $stage -le 0 ]; then
  ...
  # Create your own trial data here
...
# This is a reduced model for xvector training
# It performs similar to the bigger model but faster
